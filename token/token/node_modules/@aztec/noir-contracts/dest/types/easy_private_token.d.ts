...
export declare class EasyPrivateTokenContract extends ContractBase {
     ...
     */
    static deploy(wallet: Wallet, initial_supply: bigint | number, owner: FieldLike): DeployMethod<EasyPrivateTokenContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public key to derive the address.
     */
    static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, initial_supply: bigint | number, owner: FieldLike): DeployMethod<EasyPrivateTokenContract>;
    /**
