...
import EcdsaAccountContractArtifactJson from '../artifacts/ecdsa_account_contract.json' assert { type: 'json' };

export const EcdsaAccountContractArtifact = EcdsaAccountContractArtifactJson as ContractArtifact;
...
export class EcdsaAccountContract extends ContractBase {
  private constructor(completeAddress: CompleteAddress, wallet: Wallet, portalContract = EthAddress.ZERO) {
    super(completeAddress, EcdsaAccountContractArtifact, wallet, portalContract);
  }
