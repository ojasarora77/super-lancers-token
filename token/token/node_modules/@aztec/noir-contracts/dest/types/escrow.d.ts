...
export declare class EscrowContract extends ContractBase {
     ...
     */
    static deploy(wallet: Wallet, owner: FieldLike): DeployMethod<EscrowContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public key to derive the address.
     */
    static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, owner: FieldLike): DeployMethod<EscrowContract>;
    /**
    ...
    methods: {
        ...
        withdraw: ((token: FieldLike, amount: FieldLike, recipient: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    };
}
