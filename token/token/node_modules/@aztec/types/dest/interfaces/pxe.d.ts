...
import { AuthWitness, CompleteAddress, ContractData, ExtendedContractData, GetUnencryptedLogsResponse, L2Tx, LogFilter, NotePreimage, Tx, TxExecutionRequest, TxHash, TxReceipt } from '@aztec/types';
...
export interface PXE {
     ...
     */
    addNote(account: AztecAddress, contract: AztecAddress, storageSlot: Fr, preimage: NotePreimage, txHash: TxHash, nonce?: Fr): Promise<void>;
    /**
