...
import { AztecAddress, CompleteAddress, Fr, FunctionData, FunctionLeafPreimage, GlobalVariables, NewContractData, PrivateCallStackItem, PublicCallStackItem, PublicKey, TxRequest } from '../index.js';
/**
 ...
 */
export declare function computeCompleteAddress(wasm: IWasmModule, deployerPubKey: PublicKey, contractAddrSalt: Fr, fnTreeRoot: Fr, constructorHash: Fr): CompleteAddress;
/**
 ...
 */
export declare function computeBlockHashWithGlobals(wasm: IWasmModule, globals: GlobalVariables, noteHashTreeRoot: Fr, nullifierTreeRoot: Fr, contractTreeRoot: Fr, l1ToL2DataTreeRoot: Fr, publicDataTreeRoot: Fr): Fr;
/**
 * Computes the block hash given the blocks globals and roots.
 * @param wasm - A module providing low-level wasm access.
 ...
 * @returns The block hash.
 */
export declare function computeBlockHash(wasm: IWasmModule, globalsHash: Fr, noteHashTreeRoot: Fr, nullifierTreeRoot: Fr, contractTreeRoot: Fr, l1ToL2DataTreeRoot: Fr, publicDataTreeRoot: Fr): Fr;
/**
 ...
 */
export declare function computePublicDataTreeIndex(wasm: IWasmModule, contractAddress: AztecAddress, storageSlot: Fr): Fr;
/**
