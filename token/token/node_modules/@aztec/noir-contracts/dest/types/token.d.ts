...
export declare class TokenContract extends ContractBase {
     ...
     */
    static deploy(wallet: Wallet, admin: AztecAddressLike): DeployMethod<TokenContract>;
    /**
     * Creates a tx to deploy a new instance of this contract using the specified public key to derive the address.
     */
    static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, admin: AztecAddressLike): DeployMethod<TokenContract>;
    /**
