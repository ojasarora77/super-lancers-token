...
export declare class TestContract extends ContractBase {
    ...
    methods: {
        ...
        consume_mint_private_message: ((secret_hash_for_redeeming_minted_notes: FieldLike, amount: FieldLike, canceller: FieldLike, msg_key: FieldLike, secret_for_L1_to_L2_message_consumption: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** consume_mint_public_message(to: field, amount: field, canceller: field, msg_key: field, secret: field) */
        consume_mint_public_message: ((to: FieldLike, amount: FieldLike, canceller: FieldLike, msg_key: FieldLike, secret: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** create_l2_to_l1_message_public(amount: field, secretHash: field) */
        create_l2_to_l1_message_public: ((amount: FieldLike, secretHash: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** create_nullifier_public(amount: field, secretHash: field) */
        create_nullifier_public: ((amount: FieldLike, secretHash: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** emit_msg_sender() */
        ...
        get_portal_contract_address: ((aztec_address: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        ...
        test_code_gen: ((aField: FieldLike, aBool: boolean, aNumber: bigint | number, anArray: FieldLike[], aStruct: {
            amount: FieldLike;
