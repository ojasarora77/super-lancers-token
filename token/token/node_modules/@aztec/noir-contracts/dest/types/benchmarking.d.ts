...
export declare class BenchmarkingContract extends ContractBase {
    ...
    methods: {
        ...
        increment_balance: ((owner: FieldLike, value: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
        /** recreate_note(owner: field, index: integer) */
        recreate_note: ((owner: FieldLike, index: bigint | number) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    };
}
