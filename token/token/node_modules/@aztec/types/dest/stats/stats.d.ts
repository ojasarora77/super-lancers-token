...
export type CircuitSimulationStats = {
    ...
    /** Name of the circuit. */
    circuitName: 'base-rollup' | 'private-kernel-init' | 'private-kernel-ordering' | 'root-rollup' | 'merge-rollup' | 'private-kernel-inner' | 'public-kernel-private-input' | 'public-kernel-non-first-iteration';
    /** Duration in ms. */
    duration: number;
...
export type Stats = L1PublishStats | NodeSyncedChainHistoryStats | CircuitSimulationStats | L2BlockBuiltStats | L2BlockHandledStats | NoteProcessorCaughtUpStats | TxAddedToPoolStats;
